...
<div class="d-flex justify-content-between align-items-center bg-light border-bottom p-2 top-menu-toolbar">
    ...
    <div class="d-flex align-items-center gap-2">
        <button class="toolbar-button btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#add-dashboard-modal" data-bind="click: newDashboard">
            <i class="fa fa-plus"></i>
            <span>Add</span>
        </button>
        <button class="toolbar-button btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#add-dashboard-modal" data-bind="click: editDashboard">
            <i class="fa fa-pencil"></i>
            <span>Edit</span>
        </button>
        <button class="toolbar-button btn btn-light btn-sm" data-bind="click: RefreshAllReports">
            <i class="fa fa-refresh"></i>
            <span>Refresh</span>
        </button>
        <div class="dropdown">
            <button class="toolbar-button btn btn-light btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
