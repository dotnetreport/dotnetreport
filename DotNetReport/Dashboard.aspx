...
<div class="d-flex justify-content-between align-items-center bg-light border-bottom p-2 top-menu-toolbar">
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#" data-bind="click: ExportAllPdfReports, hidden: appSettings.useAltPdf"><i class="fa fa-file-pdf-o"></i> Pdf</a></li>
                <li><a class="dropdown-item" href="#" data-bind="click: ExportAllPdfAltReports, visible: appSettings.useAltPdf"><i class="fa fa-file-pdf-o"></i> Pdf</a></li>
                    ...
                    <ul class="dropdown-menu small" style="z-index: 1001;">
                        ...
                        <li class="dropdown dropdown-hover" data-bind="visible: ReportType()!='Single'">
                            ...
                            <ul class="dropdown-menu small">
                                ...
                                <li>
                                    <a href="#" class="dropdown-item" data-bind="click: function() { $parent.appSettings.useAltPdf ? downloadPdfAlt() : downloadPdf() }">
