...
<div class="fix-content" style="display: none;" data-bind="visible: true">
    <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    ...
                                    <small class="text-muted d-block">Grants users permission to organize and manage folders even when not in Admin Mode.</small>
                                </div>
                                <div class="form-check">
                            ...
                            <div class="card-header clearfix">
                                <div class="checkbox pull-left">
                                    <label>
                                        ...
                                        <span data-bind="text: TableName, click: function() { $root.activeTable($data); }" style="cursor: pointer"></span>
            ...
            <form id="form-joins">
                <table class="table">
                    ...
                    <tbody data-bind="foreach: pagedJoins">
                        <tr>
                            <td>
                                <select class="form-select input-medium" data-bind="options: $root.Tables.availableTables, optionsText: 'DisplayName', value: JoinTable"></select>
                            </td>
                            ...
                            <td>
                                <select class="form-select input-small" data-bind="options: $root.JoinTypes, value: JoinType"></select>
                            </td>
                            <td>
                                <select class="form-select input-medium" data-bind="options: OtherTables, optionsText: 'DisplayName', value: OtherTable"></select>
                            </td>
        ...
        <div id="manageaccess" class="tab-pane">
            <b>Reports Access</b>
            <p>
                You can setup access to invidiual Reports here
            </p>
            <hr />
                        ...
                        <div role="tabpanel" class="tab-pane" id="column-foreign">
                            ...
                            <div class="control-group" data-bind="if: $root.isStoredProcColumn() == false">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select class="form-select" data-bind="value: JoinTable, visible:ForeignKey(), options: $root.Tables.model, optionsText: 'TableName'" placeholder="Ex tblEmployees" style="display: none;"></select>
