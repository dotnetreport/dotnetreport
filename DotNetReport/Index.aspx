            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-5 my-md-0">
                        ...
                        <select id="search-report" class="form-control" data-bind="select2: {placeholder: 'Search Report by Name, Description or Data Field...', ajax: { url: url, dataType: 'json', data: query, processResults: processResults, type: 'POST' }, minimumInputLength: 2, language: language, allowClear: true }, value: selectedOption"></select>
                        </div>
                    </form>
                </div>
            </nav>
