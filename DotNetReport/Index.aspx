        ...
        <div class="card folder-panel" data-bind="visible: true" style="display: none;">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item" data-bind="visible: SelectedFolder() ? SelectedFolder().canEdit : (CanSaveReports() || adminMode())">
            ...
            <div class="card-body">
                    ...
                    <div data-bind="visible: UseReportHeader">
                        ...
                        <div class="form-group row m-1">
                            <div class="col-md-12">
                                ...
                                <label class="ms-2">
                                    <input type="checkbox" data-bind="checked: IncludeOnEveryPage" /> Include on every page in PDF/Word export
                                </label>
                            </div>
                        </div>
                ...
                <div data-bind="visible: designingFooter, with: footerDesigner" style="display: none;" class="overflow-auto">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" data-bind="checked: UseReportFooter"> Use Report Footer
                        </label>
                    </div>
                    <div data-bind="visible: UseReportFooter">
                        <p class="alert alert-info">
                            You can design the common report footer below that will be applied to all reports where report footers are turned on.
                        </p>
                        <div class="form-group row m-1" data-bind="visible: clientListIds().length > 0">
                            <div class="col-md-3 col-sm-3">
                                <label class="control-label">Footers for other Clients saved</label>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <select class="form-control"
                                        data-bind="options: clientListIds,
                                            ...
                                            optionsCaption: 'No Client Id (Global)',
                                            event: { change: function () { loadHtmlFooter(true); } }">
                                </select>
                            </div>
                            <div class="col-md-1 col-sm-1">
                                <span data-bs-toggle="tooltip" class="fa fa-question-circle helptip"
                                      title="Choose a client to design its report footer"></span>
                            </div>
                        </div>
                        <div class="form-group row m-1">
                            <div class="col-md-3 col-sm-3">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <input class="form-control text-box single-line" type="text" data-bind="value: footerClientId">
                            </div>
                            <div class="col-md-1 col-sm-1">
                                <span data-bs-toggle="tooltip" data-placement="right" class="fa fa-question-circle helptip" title="Leave blank to give all clients access (Global Report Footer)"></span>
                            </div>
                        </div>
                        <div class="form-group row m-1">
                            <div class="col-md-12">
                        ...
                        <button class="btn btn-primary btn-sm mt-2" data-bind="click: saveHtmlFooter">
                            Save Changes
                        </button>
                    </div>
                    <div data-bind="visible: !UseReportFooter()">
                        <p class="alert alert-info">
                            If you turn off the <b>Use Report Footer</b> option,
                            the <b>Report Footer</b> will not be applied in reports.
                        </p>
                        <button class="btn btn-primary btn-sm mt-2" data-bind="click: saveHtmlFooter">
                            Save Changes
                        </button>
                    ...
                    <div data-bind="if: layout()=='icons'">
                        ...
                        <div data-bind="visible: SelectedFolder() || searchReports()">
                            ...
                            <div class="list-group list-overflow">
                                ...
                                <!-- Folder search results (icon view) -->
                                                ...
                                                <div class="d-none d-md-block">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="#" data-bind="click: function() { exportReport($root.appSettings.useAltPdf ? 'pdfalt' : 'pdf');}">
                            ...
                            <div data-bind="visible: !SelectedFolder() && !searchReports()">
                                <div class="container-fluid">
                                    <div class="row fw-bold border-bottom py-2 w-100">
                                        ...
                                        <div class="col-md-6" data-bind="visible: adminMode">Access Control</div>
                                    </div>
                                    <div class="" data-bind="foreach: Folders">
                                        <div class="row py-2 border-bottom align-items-center w-100" >
                                            <div class="col-md-5 d-flex align-items-center clickable" data-bind="click: function(){ $parent.SelectedFolder($data); }">
                                                <span data-bind="visible: $root.selectMode, click: function(d,e){ isSelected(!isSelected()); e.stopPropagation(); },
                                                    css: isSelected() ? 'fa fa-check-square text-primary me-2' : 'fa fa-square-o me-2'"></span>
                                            ...
                                            <div class="col-md-1" onclick="event.stopPropagation()">
                                                <div class="dropdown" data-bind="visible: ($root.CanManageFolders() || $root.adminMode()) && (canEdit || canDelete || $root.adminMode())">
                                            ...
                                            <div class="col-md-6" data-bind="visible: $parent.adminMode">
                                    ...
                                    <div data-bind="if: reportsInFolder().length > 0 || reportsInSearch().length > 0">
                                        ...
                                        <div class="report-list" data-bind="foreach: searchReports() ? reportsInSearch() : reportsInFolder()">
                                            <div class="row border-bottom py-2 align-items-center w-100">
                                                ...
                                                <div class="col-md-1">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li data-bind="visible: !isSubReportOnly()"><hr class="dropdown-divider"></li>
                                                ...
                                                <div class="col-md-4" data-bind="visible: $parent.adminMode">
                                                    <div class="d-flex flex-wrap gap-1 align-items-center mt-1">
                                                        <span class="badge bg-info text-white" title="Manage Users" data-bind="text: userId ? '👤 ' + userId : '👤 Any User'"> </span>
                                                        <span class="badge bg-info text-white border" title="View only Users" data-bind="visible: viewOnlyUserId"> 👁 <span data-bind="text: viewOnlyUserId"></span> </span>
                                                        <span class="badge bg-info text-white border" title="Delete only Users" data-bind="visible: deleteOnlyUserId"> 🗑 <span data-bind="text: deleteOnlyUserId"></span> </span>
