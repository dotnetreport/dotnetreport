                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <div data-bind="if: $parent.adminMode">
                                                    <div class="small">
                                                        ...
                                                        <div>
                                                            Direct Link to Run Report: <a data-bind="attr: {href: '/DotNetReport/Index.aspx?linkedreport=true&noparent=true&reportId=' + reportId }" target="_blank"><span class="fa fa-link"></span></a>
                                        ...
                                        <div class="report-list" data-bind="foreach: searchReports() ? reportsInSearch() : reportsInFolder()">
                                            <div class="row border-bottom py-2 align-items-center w-100">
                                                ...
                                                <div class="col-md-1" data-bind="visible: $parent.adminMode">
                                                    <a data-bind="attr: {href: '/DotNetReport/Index.aspx?linkedreport=true&noparent=true&reportId=' + reportId }" target="_blank"><span class="fa fa-link"></span></a>
                                                    &nbsp;
                                                    <a href="#" data-bind="click: function() { navigator && navigator.clipboard && navigator.clipboard.writeText('/DotNetReport.aspx?linkedreport=true&noparent=true&reportId=' + reportId) }">
