...
<div class="container-fluid">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown" data-bind="visible: (CanManageFolders() || adminMode()) && SelectedFolder()!=null && (SelectedFolder().canEdit || SelectedFolder().canDelete)">
                                <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="fa fa-folder"></span> Folder Options
                                </a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#" data-bind="click: ManageFolder.editFolder, visible: SelectedFolder() && SelectedFolder().canEdit">Edit Selected Folder</a>
                                    <a class="dropdown-item" href="#" data-bind="click: ManageFolder.deleteFolder, visible: SelectedFolder() && SelectedFolder().canDelete">Delete Selected Folder</a>
                                </div>
                            </li>
    ...
    <div data-bind="visible: ReportMode() == 'design'" style="display: none;">
        <div class="card">
            <div class="card-header">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="#"> Designing Report</a>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <div class="alert alert-info d-inline-block" title="This feature is still in Beta release. You can turn it off from settings" style="font-size: 10pt; padding: 5px; max-width: 350px; white-space: normal; margin-bottom: 0;">
                            <i class="fa fa-info-circle"></i> Beta Feature
                        </div>
                    </div>
                </nav>
            </div>
            <div class="card-body">
                ...
                <div data-bind="if: ReportMode() == 'design'">
