                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <button class="toolbar-button btn btn-light btn-sm" data-bind="click: function() {$root.ReportMode('start');}">
                                <i class="fa fa-arrow-left"></i>
                                <span>Back to Reports</span>
                            </button>
                            <button class="toolbar-button btn btn-light btn-sm" data-bind="visible: ReportMode()=='linked'">
                                <i class="fa fa-arrow-circle-left"></i>
                                <span>Back to Parent Report</span>
                            </button>
                            <a href="#" class="toolbar-button btn btn-light btn-sm" data-bind="visible: $root.CanEdit()" data-bs-toggle="modal" data-bs-target="#modal-reportbuilder">
