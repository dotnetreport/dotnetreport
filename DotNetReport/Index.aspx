                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item dropdown" data-bind="visible: SelectedFolder() ? SelectedFolder().canEdit : (CanSaveReports() || adminMode())">
                            ...
                            <div class="dropdown" data-bind="visible: $root.CanEdit() && ReportID()">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#"
                                       data-bind="click: function(){ SaveReport(true); activeDesign(false); }"
                            ...
                            <div class="report-render" data-bind="css: { 'report-expanded': isExpanded }">
                                ...
                                <div class="report-canvas" data-bind="hidden: DontExecuteOnRun() && !reportRan()">
                                    <div class="report-container bg-light">
                                           <div class="report-inner" data-bind="style: { backgroundColor: ReportResult()?.ReportData()?.BackColor || null },
                                               css: { 'bg-white': !ReportResult()?.ReportData()?.BackColor }">
